...
Осталось в P0 один: **P0-12** — сессия после покупки. Переменная под ключ
сервис-аккаунта заведена (локальный `.env` + Vault-лист), код с graceful
degradation ещё не написан.
