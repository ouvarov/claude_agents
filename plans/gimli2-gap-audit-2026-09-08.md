...
реальные продукты down-sale). Все четыре блока с приёмкой — в §3.1.
...
Осталось в P0 пять, и каждый ждёт ответа человека: P0-10 (раскрытие на
down-sale под FTC — делается вместе с P0-13), P0-11 (FTC-флаги, Q1), P0-12
(сессия после покупки, Q2), P0-13 (ROSCA-формулировка, Q6), P0-19 (пустой
paywall при сбое биллинга, Q4).
